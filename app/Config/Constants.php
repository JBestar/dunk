...
$base_url = isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off' ? 'https://'.$httpHost : 'http://'.$httpHost."".str_replace(basename($scriptName), "", $scriptName);
...
defined('CONF_PRAGSITE_2')      || define('CONF_PRAGSITE_2', 93);         //프라그 밸런스 계정2
defined('CONF_PRAGRUN_2')       || define('CONF_PRAGRUN_2', 94);          //프라그 밸런스 상태2
defined('CONF_PRAGSITE_3')      || define('CONF_PRAGSITE_3', 95);         //프라그 밸런스 계정3
defined('CONF_PRAGRUN_3')       || define('CONF_PRAGRUN_3', 96);          //프라그 밸런스 상태3
defined('CONF_PRAGSITE_4')      || define('CONF_PRAGSITE_4', 97);         //프라그 밸런스 계정4
defined('CONF_PRAGRUN_4')       || define('CONF_PRAGRUN_4', 98);          //프라그 밸런스 상태4
defined('CONF_PRAGSITE_5')      || define('CONF_PRAGSITE_5', 99);         //프라그 밸런스 계정5
defined('CONF_PRAGRUN_5')       || define('CONF_PRAGRUN_5', 100);          //프라그 밸런스 상태5
defined('CONF_PRAGSITE_6')      || define('CONF_PRAGSITE_6', 101);         //프라그 밸런스 계정6
defined('CONF_PRAGRUN_6')       || define('CONF_PRAGRUN_6', 102);          //프라그 밸런스 상태6
defined('CONF_PRAGSITE_7')      || define('CONF_PRAGSITE_7', 103);         //프라그 밸런스 계정7
defined('CONF_PRAGRUN_7')       || define('CONF_PRAGRUN_7', 104);          //프라그 밸런스 상태7
